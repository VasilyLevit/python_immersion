...
На основе задачи о хранении данных пользователя "
Напишите к задаче тесты.
...
class Access:
    ...
    custom_errors.LevelError: В доступе отказано. Ваш уровень ниже 5
    >>> access.enter_system(User(3, 5, "Админ"), 3, "Иван")
    Traceback (most recent call last):
    custom_errors.AccessError: Пользователя с id: 3 и с именем: Иван в базе не найдено
    '''
