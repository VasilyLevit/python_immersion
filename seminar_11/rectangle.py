...
class Rectangle:
    ...
    def __sub__(self, other):
        ...
        new_a = min([self.a, self.b, other.a, other.b]) # полохой вариант подбора стороны, т.к. периметр всё равно может быть меньше любой из сторон исходных прямоугольников
        new_b = new_perimeter / 2 - new_a
        return Rectangle(new_a, new_b)
